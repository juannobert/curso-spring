...
public class UserServices {
	...
	public User findById(Long id) {
		/*
		 * O Optional nos ajuda a evitar os erros NullPointerException, tirar a
		 * necessidade da verificação (if x != null) e também a escrever um código com
		 * menos linhas e mais bonito.
		 */
