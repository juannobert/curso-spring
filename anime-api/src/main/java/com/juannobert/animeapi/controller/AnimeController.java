package com.juannobert.animeapi.controller;
...
import com.juannobert.animeapi.service.AnimeService;
import com.juannobert.animeapi.util.DateUtil;
...
@Log4j2
@RequiredArgsConstructor // Gera o construtor para todos os elementos do tipo final
public class AnimeController {
	...
	@PutMapping("{id}")
	public ResponseEntity<Void> update(@PathVariable Long id,@RequestBody AnimeRequest animeRequest){
		animeService.update(id,animeRequest);
		return ResponseEntity.status(HttpStatus.NO_CONTENT).build();
